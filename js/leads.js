...
(function () {
  ...
  function renderPager(totalPages) {
    ...
    // Compact pager: just ‹ current / total › so it never overflows a phone.
    pager.innerHTML = `
      ...
      <span class="text-[12.5px] font-semibold" style="padding:0 12px;white-space:nowrap;">${state.page} / ${totalPages}</span>
